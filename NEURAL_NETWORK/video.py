...
class NeuralNetwork:
    ...
    def main(self):
        ...
        glass_df = self.import_data("glass_no_four.csv", glass_labels)
...
############################ Video Requirement 1A and 6A #######################################################
        ...
        # loss5 = self.run_machine_mlps(5,machine_training5, machine_testing5, machine_features, True)
        # loss6 = self.run_machine_mlps(6,machine_training6, machine_testing6, machine_features, True)
...
############################ Video Requirement 2B GLASS #######################################################
        ...
        # print("\nMACHINE FOLD 1, 1 layer, 6 units, 10 epochs, 0.1 mui, 0.9 momentum")
        # self.multi_layer_feedforward_network(len(glass_training4)-len(glass_classes), 1, 6, 6, "multiple_classification_hot", glass_training4, glass_testing4, glass_classes, 10, glass_features, 0.1,0.5)

        # print("\nMACHINE FOLD 1, 1 layer,  6 units, 10 epochs, 0.1 mui, 0.5 momentum")
        # self.multi_layer_feedforward_network(len(glass_training4)-len(glass_classes), 1, 6, 6, "multiple_classification_hot", glass_training4, glass_testing4, glass_classes, 10, glass_features, 0.1,0.5)

        # print("\nMACHINE FOLD 1, 1 layer,  6 units, 20 epochs, 0.01 mui, 0.5 momentum")
        # self.multi_layer_feedforward_network(len(glass_training4)-len(glass_classes), 1, 6, 6, "multiple_classification_hot", glass_training4, glass_testing4, glass_classes, 20, glass_features, 0.01,0.5)

        # print("\nMACHINE FOLD 1, 1 layer,  6 units, 30 epochs, 0.001 mui, 0.5 momentum")
        # self.multi_layer_feedforward_network(len(glass_training4)-len(glass_classes), 1, 6, 6, "multiple_classification_hot", glass_training4, glass_testing4, glass_classes, 30, glass_features, 0.00001,0.5)

        # print("\nMACHINE FOLD 1, 1 layer,  9 units, 10 epochs, 0.1 mui, 0.9 momentum")
        # self.multi_layer_feedforward_network(len(glass_training4)-len(glass_classes), 1, 6, 6, "multiple_classification_hot", glass_training4, glass_testing4, glass_classes, 10, glass_features, 0.1,0.9)

        # print("\nMACHINE FOLD 1, 1 layer,  9 units, 2 epochs, 0.1 mui, 0.9 momentum")
        # self.multi_layer_feedforward_network(len(glass_training4)-len(glass_classes), 1, 6, 6, "multiple_classification_hot", glass_training4, glass_testing4, glass_classes, 2, glass_features, 0.1,0.9)

        ##################################### NON HOT GLASS ###############################

        print("\nMACHINE FOLD 1, 1 layer,  6 units, 2 epochs, 0.1 mui, 0.5 momentum")
        predicted = self.multi_layer_feedforward_network(len(glass_testing3)-1, 1, 6, 7, "multiple_classification", glass_training3, glass_testing3, glass_classes, 2, glass_features, 0.1, 0.5)
        loss = len(predicted[predicted['class']==predicted['Predicted']])/len(predicted)
        print('Accuracy:',loss)

        print("\nMACHINE FOLD 1, 1 layer,  9 units, 2 epochs, 0.1 mui, 0.5 momentum")
        predicted = self.multi_layer_feedforward_network(len(glass_testing3)-1, 1, 9, 7, "multiple_classification", glass_training3, glass_testing3, glass_classes, 2, glass_features, 0.1, 0.5)
        loss = len(predicted[predicted['class']==predicted['Predicted']])/len(predicted)
        print('Accuracy:',loss)

        print("\nMACHINE FOLD 1, 1 layer,  6 units, 5 epochs, 0.1 mui, 0.5 momentum")
        predicted = self.multi_layer_feedforward_network(len(glass_testing3)-1, 1, 6, 7, "multiple_classification", glass_training3, glass_testing3, glass_classes, 5, glass_features, 0.1, 0.5)
        loss = len(predicted[predicted['class']==predicted['Predicted']])/len(predicted)
        print('Accuracy:',loss)

        print("\nMACHINE FOLD 1, 1 layer,  9 units, 5 epochs, 0.1 mui, 0.5 momentum")
        predicted = self.multi_layer_feedforward_network(len(glass_testing3)-1, 1, 9, 7, "multiple_classification", glass_training3, glass_testing3, glass_classes, 5, glass_features, 0.1, 0.5)
        loss = len(predicted[predicted['class']==predicted['Predicted']])/len(predicted)
        print('Accuracy:',loss)

        print("\nMACHINE FOLD 1, 1 layer,  6 units, 10 epochs, 0.1 mui, 0.5 momentum")
        predicted = self.multi_layer_feedforward_network(len(glass_testing3)-1, 1, 6, 7, "multiple_classification", glass_training3, glass_testing3, glass_classes, 10, glass_features, 0.1, 0.5)
        loss = len(predicted[predicted['class']==predicted['Predicted']])/len(predicted)
        print('Accuracy:',loss)

        print("\nMACHINE FOLD 1, 1 layer,  6 units, 30 epochs, 0.1 mui, 0.5 momentum")
        predicted = self.multi_layer_feedforward_network(len(glass_testing3)-1, 1, 6, 7, "multiple_classification", glass_training3, glass_testing3, glass_classes, 30, glass_features, 0.1, 0.5)
        loss = len(predicted[predicted['class']==predicted['Predicted']])/len(predicted)
        print('Accuracy:',loss)

        print("\nMACHINE FOLD 1, 1 layer,  6 units, 20 epochs, 0.01 mui, 0.5 momentum")
        predicted = self.multi_layer_feedforward_network(len(glass_testing3)-1, 1, 6, 7, "multiple_classification", glass_training3, glass_testing3, glass_classes, 20, glass_features, 0.01, 0.5)
        loss = len(predicted[predicted['class']==predicted['Predicted']])/len(predicted)
        print('Accuracy:',loss)

        print("\nMACHINE FOLD 1, 1 layer,  6 units, 50 epochs, 0.01 mui, 0.5 momentum")
        predicted = self.multi_layer_feedforward_network(len(glass_testing3)-1, 1, 6, 7, "multiple_classification", glass_training3, glass_testing3, glass_classes, 50, glass_features, 0.01, 0.5)
        loss = len(predicted[predicted['class']==predicted['Predicted']])/len(predicted)
        print('Accuracy:',loss)

        print("\nMACHINE FOLD 1, 1 layer,  6 units, 30 epochs, 0.001 mui, 0.5 momentum")
        predicted = self.multi_layer_feedforward_network(len(glass_testing3)-1, 1, 6, 7, "multiple_classification", glass_training3, glass_testing3, glass_classes, 30, glass_features, 0.001, 0.5)
        loss = len(predicted[predicted['class']==predicted['Predicted']])/len(predicted)
        print('Accuracy:',loss)

        print("\nMACHINE FOLD 1, 1 layer,  6 units, 50 epochs, 0.001 mui, 0.5 momentum")
        predicted = self.multi_layer_feedforward_network(len(glass_testing3)-1, 1, 6, 7, "multiple_classification", glass_training3, glass_testing3, glass_classes, 50, glass_features, 0.001, 0.5)
        loss = len(predicted[predicted['class']==predicted['Predicted']])/len(predicted)
        print('Accuracy:',loss)
        ...
        print("\nMACHINE FOLD 1, 1 layer,  6 units, 75 epochs, 0.001 mui, 0.5 momentum")
        predicted = self.multi_layer_feedforward_network(len(glass_testing3)-1, 1, 6, 7, "multiple_classification", glass_training3, glass_testing3, glass_classes, 75, glass_features, 0.001, 0.5)
        loss = len(predicted[predicted['class']==predicted['Predicted']])/len(predicted)
        print('Accuracy:',loss)

        print("\nMACHINE FOLD 1, 1 layer,  6 units, 100 epochs, 0.001 mui, 0.5 momentum")
        predicted = self.multi_layer_feedforward_network(len(glass_testing3)-1, 1, 6, 7, "multiple_classification", glass_training3, glass_testing3, glass_classes, 100, glass_features, 0.001, 0.5)
        loss = len(predicted[predicted['class']==predicted['Predicted']])/len(predicted)
        print('Accuracy:',loss)
...
################################ SOY ########################################
        ...
        # soy_list = [soy_training1,soy_testing1,soy_training2,soy_testing2,soy_training3,soy_testing3,soy_training4,soy_testing4,soy_training5,soy_testing5,soy_training6,soy_testing6,soy_training7,soy_testing7,soy_training8,soy_testing8,soy_training9,soy_testing9,soy_training10,soy_testing10,soy_tuning]
        # soy_training1,soy_testing1,soy_training2,soy_testing2,soy_training3,soy_testing3,soy_training4,soy_testing4,soy_training5,soy_testing5,soy_training6,soy_testing6,soy_training7,soy_testing7,soy_training8,soy_testing8,soy_training9,soy_testing9,soy_training10,soy_testing10,soy_tuning = [self.one_hot_code(df, 'class') for df in soy_list]
        # predicted = self.multi_layer_feedforward_network(len(soy_training2)-len(soy_classes), 1, 20, 4, "multiple_classification_hot", soy_training2, soy_testing2, soy_classes, 2, soy_labels,0.1,0.5)
        # predicted = self.multi_layer_feedforward_network(len(soy_training2)-len(soy_classes), 1, 8, 4, "multiple_classification_hot", soy_training2, soy_testing2, soy_classes, 2, soy_labels,0.1,0.5)
        # predicted = self.multi_layer_feedforward_network(len(soy_training2)-len(soy_classes), 1, 12, 4, "multiple_classification_hot", soy_training2, soy_testing2, soy_classes, 2, soy_labels,0.1,0.5)
        # predicted = self.multi_layer_feedforward_network(len(soy_training2)-len(soy_classes), 1, 16, 4, "multiple_classification_hot", soy_training2, soy_testing2, soy_classes, 2, soy_labels,0.1,0.5)
        # predicted = self.multi_layer_feedforward_network(len(soy_training2)-len(soy_classes), 2, 4, 4, "multiple_classification_hot", soy_training2, soy_testing2, soy_classes, 10, soy_labels,0.1,0.5)
        # predicted = self.multi_layer_feedforward_network(len(soy_training2)-len(soy_classes), 2, 8, 4, "multiple_classification_hot", soy_training2, soy_testing2, soy_classes, 10, soy_labels,0.1,0.5)
        # predicted = self.multi_layer_feedforward_network(len(soy_training2)-len(soy_classes), 2, 12, 4, "multiple_classification_hot", soy_training2, soy_testing2, soy_classes, 10, soy_labels,0.1,0.5)
        # predicted = self.multi_layer_feedforward_network(len(soy_training2)-len(soy_classes), 2, 16, 4, "multiple_classification_hot", soy_training2, soy_testing2, soy_classes, 10, soy_labels,0.1,0.5)
        # predicted = self.multi_layer_feedforward_network(len(soy_training2)-len(soy_classes), 2, 16, 4, "multiple_classification_hot", soy_training2, soy_testing2, soy_classes, 20, soy_labels,0.01,0.5)
...
##############################################################################################
        ...
        # self.multi_layer_feedforward_network(len(cancer_training1)-1, 1, 10, 1, "binary_classification", cancer_training1, cancer_testing1, cancer_classes, 2, cancer_features, 0.1, 0.5)
    ...
    def check_k_classes_whj(self, mui, y, zh, vih, x, row, j_num, k, h, l, delta_whj):
    ...
    def multi_layer_feedforward_network(self, num_inputs: int, num_hidden_layers: int, num_hidden_units: int, num_outputs: int, version: str, train_df:pd.DataFrame, test_df:pd.DataFrame, class_list:list, num_iterations:int, feature_labels: list, mui, momentum = None, verbose = False):
        counter = 0
        # print(train_df)
                    ...
                    if version == "binary_classification" or version == "regression":
                        ...
                        for h in range(1, num_hidden_units+1):
                            for j in range(len(row)):
                                if l == 0:
                                    delta_whj[h-1,j] = self.check_k_classes_whj(mui, yi_dict, hidden_dict[h], vih, j, row, j, len(class_list), h, l, delta_whj)
                                else:
                                    delta_whj[h-1,j] = self.check_k_classes_whj(mui, delta_whj[h-1,j], hidden_dict[h], vih, j, row, j, len(class_list), h, l, delta_whj)
                        # print(delta_whj)
                        # end: calculate updates for w_hj
        ...
        # print("-------------------------------------------------------\n")
        test_shuffed_inputs = test_shuffed_inputs.astype({'Predicted':'int'})
    ...
    def calculate_loss_for_classification(self,classified_df, class_names):
        confusion_matrix = {}
