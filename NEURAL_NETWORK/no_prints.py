...
############################ Machine DATASETS #######################################################
        ...
        predicted = self.multi_layer_feedforward_network(len(machine_training1)-1, 0, 10, 1, "regression", norm_train1, norm_test1, ['erp'], 4, machine_features, 0.01, 0.5)
        ...
        print("\nMACHINE FOLD 1, 1 layer, 10 units, 30 epochs, 0.1 mui, 0.5 momentum")
        predicted = self.multi_layer_feedforward_network(len(machine_training1)-1, 1, 10, 1, "regression", norm_train1, norm_test1, ['erp'], 30, machine_features, 0.1, 0.5)
        predicted = self.regress_undo_normalization(predicted,'erp',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        print("LOSSES\n------------------------------------------")
        ...
        print("\nMACHINE FOLD 1, 1 layer, 10 units, 30 epochs, 0.01 mui, 0.5 momentum")
        predicted = self.multi_layer_feedforward_network(len(machine_training1)-1, 1, 10, 1, "regression", norm_train1, norm_test1, ['erp'], 30, machine_features, 0.01, 0.5)
        predicted = self.regress_undo_normalization(predicted,'erp',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        print("LOSSES\n------------------------------------------")
        ...
        print("\nMACHINE FOLD 1, 1 layer, 10 units, 30 epochs, 0.001 mui, 0.5 momentum")
        predicted = self.multi_layer_feedforward_network(len(machine_training1)-1, 1, 10, 1, "regression", norm_train1, norm_test1, ['erp'], 40, machine_features, 0.001, 0.5)
        predicted = self.regress_undo_normalization(predicted,'erp',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        print("LOSSES\n------------------------------------------")
        ...
        print("\nMACHINE FOLD 1, 1 layer, 10 units, 70 epochs, 0.001 mui, 0.5 momentum")
        predicted = self.multi_layer_feedforward_network(len(machine_training1)-1, 1, 10, 1, "regression", norm_train1, norm_test1, ['erp'], 70, machine_features, 0.001, 0.5)
        predicted = self.regress_undo_normalization(predicted,'erp',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        print("LOSSES\n------------------------------------------")
        ...
        print("\nMACHINE FOLD 1, 1 layer, 10 units, 100 epochs, 0.0001 mui, 0.5 momentum")
        predicted = self.multi_layer_feedforward_network(len(machine_training1)-1, 1, 10, 1, "regression", norm_train1, norm_test1, ['erp'], 100, machine_features, 0.0001, 0.5)
        predicted = self.regress_undo_normalization(predicted,'erp',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        print("LOSSES\n------------------------------------------")
        ...
        print("\nMACHINE FOLD 1, 2 layer, 10 units, 10 epochs, 0.001 mui, 0.9 momentum")
        predicted = self.multi_layer_feedforward_network(len(machine_training1)-1, 2, 10, 1, "regression", norm_train1, norm_test1, ['erp'], 10, machine_features, 0.001, 0.9)
        predicted = self.regress_undo_normalization(predicted,'erp',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        print("LOSSES\n------------------------------------------")
        ...
        print("\nMACHINE FOLD 1, 2 layer, 15 units, 10 epochs, 0.001 mui, 0.9 momentum")
        predicted = self.multi_layer_feedforward_network(len(machine_training1)-1, 2, 15, 1, "regression", norm_train1, norm_test1, ['erp'], 10, machine_features, 0.001, 0.9)
        predicted = self.regress_undo_normalization(predicted,'erp',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        print("LOSSES\n------------------------------------------")
        ...
        print("\nMACHINE FOLD 1, 2 layer, 20 units, 10 epochs, 0.001 mui, 0.9 momentum")
        predicted = self.multi_layer_feedforward_network(len(machine_training1)-1, 2, 20, 1, "regression", norm_train1, norm_test1, ['erp'], 10, machine_features, 0.001, 0.9)
        predicted = self.regress_undo_normalization(predicted,'erp',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        print("LOSSES\n------------------------------------------")
        ...
        print("\nMACHINE FOLD 1, 2 layer, 30 units, 10 epochs, 0.001 mui, 0.9 momentum")
        predicted = self.multi_layer_feedforward_network(len(machine_training1)-1, 2, 30, 1, "regression", norm_train1, norm_test1, ['erp'], 10, machine_features, 0.001, 0.9)
        predicted = self.regress_undo_normalization(predicted,'erp',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        print("LOSSES\n------------------------------------------")
        ...
        print("\nMACHINE FOLD 1, 2 layer, 10 units, 30 epochs, 0.001 mui, 0.9 momentum")
        predicted = self.multi_layer_feedforward_network(len(machine_training1)-1, 2, 10, 1, "regression", norm_train1, norm_test1, ['erp'], 30, machine_features, 0.001, 0.9)
        predicted = self.regress_undo_normalization(predicted,'erp',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        print("LOSSES\n------------------------------------------")
        ...
        print("\nMACHINE FOLD 1, 2 layer, 10 units, 50 epochs, 0.0001 mui, 0.9 momentum")
        predicted = self.multi_layer_feedforward_network(len(machine_training1)-1, 2, 10, 1, "regression", norm_train1, norm_test1, ['erp'], 50, machine_features, 0.0001, 0.9)
        predicted = self.regress_undo_normalization(predicted,'erp',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        print("LOSSES\n------------------------------------------")
        ...
        print("\nMACHINE FOLD 1, 2 layer, 15 units, 50 epochs, 0.0001 mui, 0.9 momentum")
        predicted = self.multi_layer_feedforward_network(len(machine_training1)-1, 2, 15, 1, "regression", norm_train1, norm_test1, ['erp'], 50, machine_features, 0.0001, 0.9)
        predicted = self.regress_undo_normalization(predicted,'erp',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        print("LOSSES\n------------------------------------------")
        ...
        print("\nMACHINE FOLD 1, 2 layer, 10 units, 70 epochs, 0.0001 mui, 0.9 momentum")
        predicted = self.multi_layer_feedforward_network(len(machine_training1)-1, 2, 10, 1, "regression", norm_train1, norm_test1, ['erp'], 70, machine_features, 0.0001, 0.9)
        predicted = self.regress_undo_normalization(predicted,'erp',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        print("LOSSES\n------------------------------------------")
        ...
        print("\nMACHINE FOLD 1, 2 layer, 10 units, 100 epochs, 0.0001 mui, 0.9 momentum")
        predicted = self.multi_layer_feedforward_network(len(machine_training1)-1, 2, 10, 1, "regression", norm_train1, norm_test1, ['erp'], 70, machine_features, 0.0001, 0.9)
        predicted = self.regress_undo_normalization(predicted,'erp',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        ...
        print("\nMACHINE FOLD 1, 2 layer, 10 units, 200 epochs, 0.0001 mui, 0.9 momentum")
        predicted = self.multi_layer_feedforward_network(len(machine_training1)-1, 2, 10, 1, "regression", norm_train1, norm_test1, ['erp'], 70, machine_features, 0.0001, 0.9)
        predicted = self.regress_undo_normalization(predicted,'erp',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        ...
        print("\nMACHINE FOLD 1, 2 layer, 10 units, 100 epochs, 0.00001 mui, 0.9 momentum")
        predicted = self.multi_layer_feedforward_network(len(machine_training1)-1, 2, 10, 1, "regression", norm_train1, norm_test1, ['erp'], 70, machine_features, 0.00001, 0.9)
        predicted = self.regress_undo_normalization(predicted,'erp',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        print("LOSSES\n------------------------------------------")
        ...
        print("\nMACHINE FOLD 1, 2 layer, 10 units, 200 epochs, 0.00001 mui, 0.9 momentum")
        predicted = self.multi_layer_feedforward_network(len(machine_training1)-1, 2, 10, 1, "regression", norm_train1, norm_test1, ['erp'], 70, machine_features, 0.00001, 0.9)
        predicted = self.regress_undo_normalization(predicted,'erp',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        ...
        # self.run_machine_mlps(2,machine_training2, machine_testing2, machine_features)
        # self.run_machine_mlps(3,machine_training3, machine_testing3, machine_features)
        # self.run_machine_mlps(4,machine_training4, machine_testing4, machine_features)
        # self.run_machine_mlps(5,machine_training5, machine_testing5, machine_features)
        # self.run_machine_mlps(6,machine_training6, machine_testing6, machine_features)
        # self.run_machine_mlps(7,machine_training7, machine_testing7, machine_features)
        # self.run_machine_mlps(8,machine_training8, machine_testing8, machine_features)
        # self.run_machine_mlps(9,machine_training9, machine_testing9, machine_features)
        # self.run_machine_mlps(10,machine_training10, machine_testing2, machine_features)

        ######################### FOREST_FIRE MLPS ################################
        norm_train1, xmax, xmin = self.regress_class_normalization(forestfires_training1, 'area')
        norm_test1, xmax, xmin = self.regress_class_normalization(forestfires_testing1, 'area')
        # print(norm_test1)

        # print("\nforestfires FOLD 1, 0 layer, 5 units, 2 epochs, 0.1 mui, 0.5 momentum, 2 iteration")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 0, 5, 1, "regression", norm_train1, norm_test1, ['area'], 2, forestfires_features, 0.1, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        # print("LOSSES\n------------------------------------------")
        # print(self.calculate_loss_for_regression(predicted))

        # print("\nforestfires FOLD 1, 1 layer, 5 units, 2 epochs, 0.1 mui, 0.5 momentum, 2 iteration")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 1, 5, 1, "regression", norm_train1, norm_test1, ['area'], 2, forestfires_features, 0.1, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nforestfires FOLD 1, 1 layer, 10 units, 2 epochs, 0.1 mui, 0.5 momentum, 2 iteration")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 1, 10, 1, "regression", norm_train1, norm_test1, ['area'], 2, forestfires_features, 0.1, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nforestfires FOLD 1, 1 layer, 15 units, 2 epochs, 0.1 mui, 0.5 momentum, 2 iteration")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 1, 15, 1, "regression", norm_train1, norm_test1, ['area'], 2, forestfires_features, 0.1, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nforestfires FOLD 1, 1 layer, 5 units, 10 epochs, 0.01 mui, 0.5 momentum, 5 iteration")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 1, 10, 1, "regression", norm_train1, norm_test1, ['area'], 5, forestfires_features, 0.01, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nforestfires FOLD 1, 1 layer, 10 units, 10 epochs, 0.01 mui, 0.5 momentum, 10 iteration")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 1, 10, 1, "regression", norm_train1, norm_test1, ['area'], 10, forestfires_features, 0.01, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        # # predicted[predicted['Predicted'].lt(0)] = 0
        # # predicted['Predicted'] = np.where(predicted['Predicted'] < 0, 0, predicted['Predicted'])
        # print("LOSSES\n------------------------------------------")
        # print(self.calculate_loss_for_regression(predicted))

        # print("\nforestfires FOLD 1, 1 layer, 15 units, 10 epochs, 0.01 mui, 0.5 momentum, 10 iteration")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 1, 15, 1, "regression", norm_train1, norm_test1, ['area'], 10, forestfires_features, 0.01, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nforestfires FOLD 1, 1 layer, 10 units, 50 epochs, 0.001 mui, 0.5 momentum, 50 iterations")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 1, 10, 1, "regression", norm_train1, norm_test1, ['area'], 50, forestfires_features, 0.001, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nforestfires FOLD 1, 1 layer, 10 units, 10 epochs, 0.01 mui, 0.5 momentum, ten iterations")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 2, 10, 1, "regression", norm_train1, norm_test1, ['area'], 10, forestfires_features, 0.01, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nforestfires FOLD 1, 2 layer, 10 units, 10 epochs, 0.001 mui, 0.9 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 2, 10, 1, "regression", norm_train1, norm_test1, ['area'], 10, forestfires_features, 0.001, 0.9)
        # predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        # print("LOSSES\n------------------------------------------")
        ...
        # print("\nforestfires FOLD 1, 2 layer, 10 units, 20 epochs, 0.001 mui, 0.9 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 2, 10, 1, "regression", norm_train1, norm_test1, ['area'], 20, forestfires_features, 0.001, 0.9)
        # predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        # print("LOSSES\n------------------------------------------")
        ...
        # print("\nforestfires FOLD 1, 2 layer, 15 units, 10 epochs, 0.001 mui, 0.9 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 2, 15, 1, "regression", norm_train1, norm_test1, ['area'], 10, forestfires_features, 0.001, 0.9)
        # predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        # print("LOSSES\n------------------------------------------")
        ...
        # print("\nforestfires FOLD 1, 2 layer, 15 units, 20 epochs, 0.001 mui, 0.9 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 2, 15, 1, "regression", norm_train1, norm_test1, ['area'], 20, forestfires_features, 0.001, 0.9)
        # predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        # print("LOSSES\n------------------------------------------")
        ...
        # self.run_forestfires_mlps(2,forestfires_training2, forestfires_testing2, forestfires_features)
        # self.run_forestfires_mlps(3,forestfires_training3, forestfires_testing3, forestfires_features)
        # self.run_forestfires_mlps(4,forestfires_training4, forestfires_testing4, forestfires_features)
        # self.run_forestfires_mlps(5,forestfires_training5, forestfires_testing5, forestfires_features)
        # self.run_forestfires_mlps(6,forestfires_training6, forestfires_testing6, forestfires_features)
        # self.run_forestfires_mlps(7,forestfires_training7, forestfires_testing7, forestfires_features)
        # self.run_forestfires_mlps(8,forestfires_training8, forestfires_testing8, forestfires_features)
        # self.run_forestfires_mlps(9,forestfires_training9, forestfires_testing9, forestfires_features)
        # self.run_forestfires_mlps(10,forestfires_training10, forestfires_testing2, forestfires_features)

        ######################### ABALONE MLPS ################################

        
        norm_train1, xmax, xmin = self.regress_class_normalization(abalone_training1, 'rings')
        norm_test1, xmax, xmin = self.regress_class_normalization(abalone_testing1, 'rings')
        # print(norm_test1)

        # print("\nabalone FOLD 1, 0 layer, 5 units, 2 epochs, 0.1 mui, 0.5 momentum, 2 iteration")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 0, 5, 1, "regression", norm_train1, norm_test1, ['rings'], 2, abalone_features, 0.1, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        # print("LOSSES\n------------------------------------------")
        ...
        # print("\nabalone FOLD 1, 1 layer, 15 units, 10 epochs, 0.1 mui, 0.5 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 1, 15, 1, "regression", norm_train1, norm_test1, ['rings'], 10, abalone_features, 0.1, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nabalone FOLD 1, 1 layer, 15 units, 30 epochs, 0.01 mui, 0.5 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 1, 15, 1, "regression", norm_train1, norm_test1, ['rings'], 30, abalone_features, 0.01, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nabalone FOLD 1, 1 layer, 15 units, 50 epochs, 0.001 mui, 0.5 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 1, 15, 1, "regression", norm_train1, norm_test1, ['rings'], 50, abalone_features, 0.001, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nabalone FOLD 1, 1 layer, 20 units, 10 epochs, 0.1 mui, 0.5 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 1, 20, 1, "regression", norm_train1, norm_test1, ['rings'], 10, abalone_features, 0.1, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nabalone FOLD 1, 1 layer, 15 units, 20 epochs, 0.1 mui, 0.5 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 1, 15, 1, "regression", norm_train1, norm_test1, ['rings'], 20, abalone_features, 0.1, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nabalone FOLD 1, 1 layer, 20 units, 20 epochs, 0.1 mui, 0.5 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 1, 20, 1, "regression", norm_train1, norm_test1, ['rings'], 20, abalone_features, 0.1, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nabalone FOLD 1, 1 layer, 15 units, 30 epochs, 0.1 mui, 0.5 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 1, 15, 1, "regression", norm_train1, norm_test1, ['rings'], 30, abalone_features, 0.1, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nabalone FOLD 1, 1 layer, 20 units, 30 epochs, 0.1 mui, 0.5 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 1, 20, 1, "regression", norm_train1, norm_test1, ['rings'], 30, abalone_features, 0.1, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nabalone FOLD 1, 1 layer, 15 units, 70 epochs, 0.001 mui, 0.5 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 1, 15, 1, "regression", norm_train1, norm_test1, ['rings'], 70, abalone_features, 0.001, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # # print(predicted)
        ...
        # print("\nabalone FOLD 1, 1 layer, 15 units, 100 epochs, 0.0001 mui, 0.5 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 1, 15, 1, "regression", norm_train1, norm_test1, ['rings'], 100, abalone_features, 0.0001, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nabalone FOLD 1, 1 layer, 15 units, 150 epochs, 0.0001 mui, 0.5 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 1, 15, 1, "regression", norm_train1, norm_test1, ['rings'], 150, abalone_features, 0.0001, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nabalone FOLD 1, 1 layer, 15 units, 60 epochs, 0.001 mui, 0.5 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 1, 15, 1, "regression", norm_train1, norm_test1, ['rings'], 60, abalone_features, 0.001, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nabalone FOLD 1, 1 layer, 15 units, 65 epochs, 0.001 mui, 0.5 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 1, 15, 1, "regression", norm_train1, norm_test1, ['rings'], 65, abalone_features, 0.001, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nabalone FOLD 1, 2 layer, 15 units, 70 epochs, 0.001 mui, 0.5 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 2, 15, 1, "regression", norm_train1, norm_test1, ['rings'], 70, abalone_features, 0.001, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nabalone FOLD 1, 2 layer, 15 units, 100 epochs, 0.0001 mui, 0.5 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 2, 15, 1, "regression", norm_train1, norm_test1, ['rings'], 100, abalone_features, 0.0001, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # print("\nabalone FOLD 1, 2 layer, 15 units, 150 epochs, 0.0001 mui, 0.5 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 2, 15, 1, "regression", norm_train1, norm_test1, ['rings'], 150, abalone_features, 0.0001, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        # self.run_abalone_mlps(2,abalone_training2, abalone_testing2, abalone_features)
        # self.run_abalone_mlps(3,abalone_training3, abalone_testing3, abalone_features)
        # self.run_abalone_mlps(4,abalone_training4, abalone_testing4, abalone_features)
        # self.run_abalone_mlps(5,abalone_training5, abalone_testing5, abalone_features)
        # self.run_abalone_mlps(6,abalone_training6, abalone_testing6, abalone_features)
        # self.run_abalone_mlps(7,abalone_training7, abalone_testing7, abalone_features)
        # self.run_abalone_mlps(8,abalone_training8, abalone_testing8, abalone_features)
        # self.run_abalone_mlps(9,abalone_training9, abalone_testing9, abalone_features)
        # self.run_abalone_mlps(10,abalone_training10, abalone_testing2, abalone_features)
...
##############################################################################################
    ...
    def run_machine_mlps(self, num, machine_training, machine_testing, features):
    ...
    def run_abalone_mlps(self, num, abalone_training, abalone_testing, features):
        
        print("Abalone FOLD {}, 0 layers".format(num))
        norm_train, xmax, xmin = self.regress_class_normalization(abalone_training, 'rings')
        norm_test, xmax, xmin = self.regress_class_normalization(abalone_testing, 'rings')
        predicted = self.multi_layer_feedforward_network(len(abalone_training)-1, 0, 10, 1, "regression", norm_train, norm_test, ['rings'], 4, features, 0.01, 0.5)
        predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        print("LOSSES\n------------------------------------------")
        ...
        # print("\nabalone FOLD 1, 1 layer, 15 units, 100 epochs, 0.0001 mui, 0.5 momentum")
        # predicted = self.multi_layer_feedforward_network(len(norm_train)-1, 1, 15, 1, "regression", norm_train, norm_test, ['rings'], 100, features, 0.0001, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        print("\nabalone FOLD {}, 1 layer, 15 units, 70 epochs, 0.001 mui, 0.5 momentum".format(num))
        predicted = self.multi_layer_feedforward_network(len(norm_train)-1, 1, 15, 1, "regression", norm_train, norm_test, ['rings'], 70, features, 0.001, 0.5)
        predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        print("\nabalone FOLD {}, 2 layer, 15 units, 100 epochs, 0.0001 mui, 0.5 momentum".format(num))
        predicted = self.multi_layer_feedforward_network(len(norm_train)-1, 2, 15, 1, "regression", norm_train, norm_test, ['rings'], 100, features, 0.0001, 0.5)
        predicted = self.regress_undo_normalization(predicted,'rings',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
    ...
    def run_forestfires_mlps(self, num, norm_train1, norm_test1, features):
        norm_train, xmax, xmin = self.regress_class_normalization(norm_train1, 'area')
        norm_test, xmax, xmin = self.regress_class_normalization(norm_test1, 'area')
        
        # print("forestfires FOLD {}, 0 layers".format(num))
        # predicted = self.multi_layer_feedforward_network(len(norm_train1)-1, 0, 10, 1, "regression", norm_train, norm_test, ['area'], 4, features, 0.01, 0.5)
        # predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        # predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # # print(predicted)
        # print("LOSSES\n------------------------------------------")
        ...
        print("\nforestfires FOLD {}, 1 layer, 10 units, 2 epochs, 0.1 mui, 0.5 momentum, 2 iteration".format(num))
        predicted = self.multi_layer_feedforward_network(len(norm_train)-1, 1, 10, 1, "regression", norm_train, norm_test, ['area'], 2, features, 0.1, 0.5)
        predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        print("\nforestfires FOLD {}, 1 layer, 15 units, 10 epochs, 0.01 mui, 0.5 momentum, 10 iteration".format(num))
        predicted = self.multi_layer_feedforward_network(len(norm_train)-1, 1, 15, 1, "regression", norm_train, norm_test, ['area'], 10, features, 0.01, 0.5)
        predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        print("\nforestfires FOLD {}, 1 layer, 15 units, 35 epochs, 0.001 mui, 0.5 momentum, 10 iteration".format(num))
        predicted = self.multi_layer_feedforward_network(len(norm_train)-1, 1, 15, 1, "regression", norm_train, norm_test, ['area'], 35, features, 0.001, 0.5)
        predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        print("\nforestfires FOLD {}, 1 layer, 15 units, 50 epochs, 0.0001 mui, 0.5 momentum, 10 iteration".format(num))
        predicted = self.multi_layer_feedforward_network(len(norm_train)-1, 1, 15, 1, "regression", norm_train, norm_test, ['area'], 50, features, 0.0001, 0.5)
        predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        print("\nforestfires FOLD {}, 1 layer, 15 units, 80 epochs, 0.00001 mui, 0.5 momentum, 10 iteration".format(num))
        predicted = self.multi_layer_feedforward_network(len(norm_train)-1, 1, 15, 1, "regression", norm_train, norm_test, ['area'], 80, features, 0.00001, 0.5)
        predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        print("\nforestfires FOLD {}, 1 layer, 15 units, 100 epochs, 0.00001 mui, 0.5 momentum, 10 iteration".format(num))
        predicted = self.multi_layer_feedforward_network(len(norm_train)-1, 1, 15, 1, "regression", norm_train, norm_test, ['area'], 100, features, 0.00001, 0.5)
        predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        predicted.loc[predicted['Predicted'] < 0, 'Predicted'] = 0
        # print(predicted)
        ...
        print("\nforestfires FOLD {}, 2 layer, 15 units, 20 epochs, 0.001 mui, 0.9 momentum".format(num))
        predicted = self.multi_layer_feedforward_network(len(norm_train)-1, 2, 15, 1, "regression", norm_train, norm_test, ['area'], 20, features, 0.001, 0.9)
        predicted = self.regress_undo_normalization(predicted,'area',xmax,xmin)
        predicted = self.regress_undo_normalization(predicted,'Predicted',xmax,xmin)
        # print(predicted)
        print("LOSSES\n------------------------------------------")
